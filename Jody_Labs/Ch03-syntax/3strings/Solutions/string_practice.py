...
print ('To display double quotes, use (\\") if you are inside of double quotes.')
...
# data1 = 'NAME', 'AGE', 'HANDEDNESS', 'SCORE (%)';

# data2 = 'Martin', 38, 'L', 54.123],
#         ['Marty', 33, 'L', 32.438],
#         ['Martine', 25, 'R', 71.128],


#Dynamically insert a variable into a string at runtime
name = 'Francois'
